...
public class AppendOptimisticLockingHandler
    ...
    public void accept(MetadataByteBuffer metadataByteBuffer, SynchronousSink<MetadataByteBuffer> sink) {
        ...
        try {
            ...
            Attributes attributes = Attributes.of(AttributeKey.stringKey("kurrent.streamId"), streamId);
            ...
            OpenTelemetryHelpers.time(writeTimer, attributes, () -> {
                ...
                // Append to Kurrent, and retry on timeouts
                AppendToStreamOptions appendOptions = AppendToStreamOptions.get()
                        .deadline(30000);
                options.accept(appendOptions);
                metadataByteBuffer.metadata().getLong(KurrentMetadata.expectedPosition).ifPresent(appendOptions::streamRevision);
                ...
                while (true) {
                    try {
                        ...
                        metadataByteBuffer.metadata().toBuilder().add(KurrentMetadata.streamPosition, streamPosition);
