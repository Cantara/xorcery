 ...
 */
package dev.xorcery.kurrent.jsonapi.api;
...
public record KurrentMetadata(Metadata context)
    implements RequestMetadata, DeploymentMetadata
{
        ...
        implements RequestMetadata.Builder<Builder>, DeploymentMetadata.Builder<Builder>
    {
        ...
        public KurrentMetadata build() {
            return new KurrentMetadata(builder.build());
        }
    }
