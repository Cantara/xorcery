...
import dev.xorcery.domainevents.api.Model.JsonDomainEventModel;
...
import static dev.xorcery.domainevents.api.Model.JsonDomainEventModel.*;
...
public record JsonDomainEvent(ObjectNode json)
        ...
        implements With<Builder>
    {
        public Builder(String eventName) {
            ...
            // Don't set this, it's the default anyway: builder.set("@class", builder.textNode("dev.xorcery.domainevents.api.JsonDomainEvent"));
