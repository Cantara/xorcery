    ...
    String json = """
            {
                ...
                "metadata": {
                  ...
                  "domain": "forum",
                  "aggregateType": "dev.xorcery.forum.resources.aggregates.PostEntity",
                  "commandType": "dev.xorcery.forum.resources.aggregates.PostEntity$CreatePost",
                ...
                "data": [
                  {
                    "@class": "dev.xorcery.forum.resources.events.PostEvents$CreatedPost"
                  },
                  {
                    "@class": "dev.xorcery.forum.resources.events.PostEvents$UpdatedPost",
                    "title": "Test",
                    "body": "Test"
                  }
                ]
