...
public class ClientSubscriberSubProtocolHandler<OUTPUT>
    ...
    public void onWebSocketText(String message) {
        ...
        try {
            ...
            if (json instanceof ObjectNode serverContextNode) {
                ...
                reactor.util.context.Context context = reactor.util.context.Context.of(contextMap);
    ...
    private boolean initWriter(String serverAcceptType) {
        if (serverAcceptType == null) {
            getSession().close(StatusCode.SERVER_ERROR, "publisher subprotocol requires Accept header", Callback.NOOP);
            return false;
        }
