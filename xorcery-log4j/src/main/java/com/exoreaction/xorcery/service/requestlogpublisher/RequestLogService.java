...
public class RequestLogService
    ...
    public RequestLogService(ReactiveStreamsClient reactiveStreams,
        ...
        reactiveStreams.publish(configuration.getString("requestlog.subscriber.host").orElseThrow(), configuration.getString("requestlog.subscriber.stream").orElseThrow(),
                () -> configuration.getConfiguration("requestlog.subscriber.configuration"), requestLogPublisher, RequestLogPublisher.class, configuration.getConfiguration("requestlog.publisher.configuration"));
