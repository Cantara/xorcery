...
public class LoggingEventsSubscriber
    ...
    public LoggingEventsSubscriber(RestHighLevelClient client, Configuration consumerConfiguration, Configuration sourceConfiguration) {
        this.client = client;
    ...
    public void onEvent(Event<ObjectNode> event, long sequence, boolean endOfBatch) throws Exception {
        ...
        String indexName = "logging-"+lmd.getEnvironment()+"-"+lmd.getTag()+"-"+lmd.getName()+"-"+ date.getYear()+""+date.getMonthValue();
