...
public class ClientPublisherConductorListener extends AbstractConductorListener {
    ...
    public ClientPublisherConductorListener(ServiceIdentifier serviceIdentifier, Function<Configuration, Flow.Publisher<?>> publisherFactory, Class<? extends Flow.Publisher<?>> publisherType, String rel, ReactiveStreams2 reactiveStreams) {
