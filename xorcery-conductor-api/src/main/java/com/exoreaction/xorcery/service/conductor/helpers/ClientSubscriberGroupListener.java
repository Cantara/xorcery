...
public class ClientSubscriberGroupListener extends AbstractGroupListener {
    ...
    public ClientSubscriberGroupListener(ServiceIdentifier serviceIdentifier, Function<Configuration, Flow.Subscriber<?>> subscriberFactory, Class<? extends Flow.Subscriber<?>> subscriberType, String rel, ReactiveStreamsClient reactiveStreams) {
